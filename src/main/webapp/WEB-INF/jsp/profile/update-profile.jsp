      ...
      <div class="row g-4">
         ...
         <div class="col-xl-9">
            <div class="update-profile bg-white py-5 px-4">
               ...
               <form class="profile-form" action="#" method="POST" >
                  ...
                  <!-- <div class="file-upload text-center rounded-3 mb-5">
                     ...
                     <img src="https://www.flowchakra.in/public/frontend/default/assets/img/icons/image.svg?v=v2.1.0" alt="dp"
                        class="img-fluid">
                     <p class="text-dark fw-bold mb-2 mt-3">Drop your files here or browse</p>
                     ...
                     <div class="col-sm-12">
                        <div class="label-input-field">
                           ...
                           <input type="text" name="name" placeholder="Your name"
                              value="${customerProfile.firstName} ${customerProfile.lastName}" disabled>
                        </div>
                     </div>
                     <div class="col-sm-6">
                        <div class="label-input-field">
                           ...
                           <input type="email" name="email" placeholder="Your Email"
                              value="${customerProfile.email}" disabled>
                        </div>
                     </div>
                     <div class="col-sm-6">
                        <div class="label-input-field">
                           ...
                           <input type="text" name="phone" placeholder="Your Phone"
                              value="${customerProfile.mobileNumber}" disabled>
                        </div>
                     </div>
                  </div>
            ...
            <div class="change-password bg-white py-5 px-4 mt-4 rounded">
               ...
               <form:form method="POST" modelAttribute="passwordReset" action="${pageContext.request.contextPath}/reset-password"  class="form-signin">
                  <spring:bind path="newPassword">
                  <div class="row g-4">
                     <div class="col-sm-6">
                        <div class="label-input-field">
                           <label>New Password</label>
                           <form:input type="password" path="newPassword" name="newPassword" placeholder="******" required="true" ></form:input>
                        </div>
                        <form:errors style="color:red;" path="newPassword"></form:errors>
                     </div>
                     </spring:bind>
                     ...
                     <div class="col-sm-6">
                        <div class="label-input-field">
                           ...
                           <form:input type="password" path="confirmPassword" name="confirmPassword" placeholder="******" required="true"></form:input>
                        </div>
                         <form:errors style="color:red;" path="confirmPassword"></form:errors>
                     </div>
                     </spring:bind>
                  </div>
                  <button type="submit" class="btn btn-primary mt-6">Change Password</button>
               </form:form>
            </div>
         </div>
      </div>
