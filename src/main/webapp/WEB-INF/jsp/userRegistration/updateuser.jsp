...
<div class="content-wrapper">
   <form:form method="POST" modelAttribute="registerUser" action="${pageContext.request.contextPath}/updateSelectedUser" enctype="multipart/form-data" class="form-signin">
      ...
      <div class="row">
        ...
        <spring:bind path="c_address">
              ...
              <spring:bind path="email">
                 <div class="form-group col-lg-3 ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="email" class="form-control" value="${usersDetails.email}" autocomplete="off"  oncopy="return false" onpaste="return false" placeholder="Email"
                       autofocus="true"></form:input>
   ...
   function getStatesOnLoad(){
    ...
    function getGenderOnLoad(){
      ...
      getCompany();
       ...
       g  getSchools($('#sid').val(),$('#did').val(),$('#ebid').val());
