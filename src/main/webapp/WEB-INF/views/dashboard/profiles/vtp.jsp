 <div class="page-content fade-in-up">
                                                      ...
                                                      <div class="row no-gutters">
                                                        ...
                                                        <div class="col-md-8">
                                                          <div class="card-body">
                                                            ...
                                                            <a href="${pageContext.request.contextPath}/viewTeacherReportVtp" class="btn btn-danger">View</a>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                                     <div class="card">
                                       <div class="row no-gutters">
                                         ...
                                         <div class="col-md-8">
                                           <div class="card-body">
                                             <h5 class="card-title">Reports (Attendance)</h5>
                                             <a href="${pageContext.request.contextPath}/attendanceReportVTP" class="btn btn-warning">View</a>
                                           </div>
                                         </div>
                                       </div>
                                     </div>
                              ...
                              <div class="row no-gutters">
                                ...
                                <div class="col-md-8">
                                  <div class="card-body">
                                    ...
                                    <a href="${pageContext.request.contextPath}/viewStudentReportVtp" class="btn btn-primary">View</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                     <div class="card">
                                       <div class="row no-gutters">
                                         <div class="col-md-4">
                                           <img src="${pageContext.request.contextPath}/resources/images/school/placements.png" style="padding:15px;" class="card-img" alt="Image">
                                         </div>
                                         <div class="col-md-8">
                                           <div class="card-body">
  ...
  <div class="col-md-6 col-lg-3">
                                     <div class="card">
                                       <div class="row no-gutters">
                                         <div class="col-md-4">
                                           <img src="${pageContext.request.contextPath}/resources/images/school/exam.png" style="padding:15px;" class="card-img" alt="Image">
                                         </div>
                                         <div class="col-md-8">
                                           <div class="card-body">
                                             <h5 class="card-title">Students Result</h5>
                                             <a href="${pageContext.request.contextPath}/viewResults" class="btn btn-warning">View</a>
                                           </div>
                                         </div>
                                       </div>
                                     </div>
